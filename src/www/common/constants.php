...
// Při startu aplikace se porovná s hodnotou db_version v tabulce config.
...
// Jak často posílat heartbeat (sekundy)
define('PROXY_HEARTBEAT_INTERVAL', 270);  // 4.5 minuty — worker měří každých 5 minut
